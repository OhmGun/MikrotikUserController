...
<table class="table">
  ...
  <tr>
    <td class="align-middle"><?= $_name ?></td><td><input class="form-control" type="text" autocomplete="off" name="name" value="" placeholder="E-mail Solusi 247" required="1" autofocus></td>
  </tr>
  <tr>
