      ...
      <div class="box bmh-75 box-bordered">
        ...
        <div class="row">
          <div  class="col-8">
            ...
            <div class="card">
              <div class="card-header"><h3><i class="fa fa-wifi"></i> User Activity</h3></div>
                <div class="card-body">
                  <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h3><a onclick="cancelPage()" href="./?hotspot=log&session=<?= $session; ?>" title="Open User Log" ><i class="fa fa-align-justify"></i> <?= $_hotspot_log ?></a></h3></div>
                  <div class="card-body">
