...
// get & counting hotspot active
  ...
  ?>
            ...
            <div id="r_2" class="card">
              <div class="card-header"><h3><i class="fa fa-wifi"></i> User Management</h3></div>
                <div class="card-body">
                  <div class="row">
  ...
  ?>
              ...
              <div class="card">
                <div class="card-header">
                  <h3><a href="./?hotspot=log&session=<?= $session; ?>" title="Open User Log" ><i class="fa fa-align-justify"></i> <?= $_hotspot_log ?></a></h3></div>
                    <div class="card-body">
