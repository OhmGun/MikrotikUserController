...
$_by_comment = "By Work Division";
$_cancel = "Cancel";
$_character = "Character";
$_close = "Close";
$_comment = "Work Division";
$_confirm = "Confirm";
...
$_help = "Help";
$_hosts = "Hosts";
$_hotspot_active = "User Active";
$_hotspot_cookies = "Cookies";
$_hotspot_log = "User Log";
$_hotspot_name = "Device Name";
$_hotspot_users = "User";
$_hours = "hours";
