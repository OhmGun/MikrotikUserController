...
<div id="navbar" class="navbar">
  ...
  <div style="display: none;">
      ...
      <a>
      <img src="img/logo.png" style="min-width: 160px; width: 20px; height: 35px;" />
      </a>
...
<div id="sidenav" class="sidenav">
  ...
  <!--hotspot-->
  <div class="dropdown-btn <?= $susers . $suserprof . $sactive . $shosts . $sipbind . $scookies; ?>"><i class="fa fa-wifi"></i> User Management
